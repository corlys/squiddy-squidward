module.exports = class Init1656066799899 {
  name = 'Init1656066799899'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "token" ("id" character varying NOT NULL, "token_id" integer NOT NULL, "uri" text, "owner_id" character varying, "contract_id" character varying, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`)
