module.exports = class Init1658717703685 {
  name = 'Init1658717703685'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "token" ("id" character varying NOT NULL, "token_id" integer, "uri" text, "is_listed" boolean, "price" numeric, "image_uri" text, "owner_id" character varying, "contract_id" character varying, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`)
